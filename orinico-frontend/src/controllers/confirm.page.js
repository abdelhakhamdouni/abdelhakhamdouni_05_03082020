...
<h2 class="text-center w-100 my-2">Mes coordonnées</h2>
    ...
    <p  class="pl-5"><strong style="font-size: 1em; ">Nom: </strong> ${
      lastOrder.lastName + " " + lastOrder.firstName
    } </p>
    <p  class="pl-5">
        <span class=""><strong style="font-size: 1em; ">Téléphone: </strong>${
          lastOrder.telephone
        }</span>
    </p>    
    <p class="pl-5">
        <span class=""><strong style="font-size: 1em; ">E-mail: </strong>${
          lastOrder.email
        }</span>
    </p>    
    <p  class="pl-5"><strong style="font-size: 1em; ">Adressede livraison: </strong>${
      lastOrder.address + " " + lastOrder.city + " " + lastOrder["code-postale"]
    }</p>
</div>
